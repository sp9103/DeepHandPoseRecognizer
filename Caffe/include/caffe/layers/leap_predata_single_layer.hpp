...
namespace caffe {
	...
	class LeapPredataSingleLayer : public BaseDataLayer<Dtype> {
	public:
		explicit LeapPredataSingleLayer(const LayerParameter& param)
			: BaseDataLayer<Dtype>(param) {}
		virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
			const vector<Blob<Dtype>*>& top);

		virtual inline const char* type() const { return "LeapPredataSingle"; }
